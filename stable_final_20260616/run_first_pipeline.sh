...
if [ "$LOCK_STABLE_CONFIG" = "1" ]; then
  ...
  MAX_WRIST_DELTA="${MAX_WRIST_DELTA:-1.45}"
fi
...
log_section "DONE"
echo "[DONE] GRASP EXECUTED."
echo "[DONE] Single-target pick pipeline selesai untuk TEST_NAME=$TEST_NAME."
